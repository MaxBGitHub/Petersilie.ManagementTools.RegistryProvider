...
namespace Petersilie.ManagementTools.RegistryProvider
{
	...
	** desired C# data type. */
	internal static class ObjectConverter
	{
		...
		public static string ToString(ManagementBaseObject baseObj, string property)
		{
		...
		public static UInt64[] ToUInt64Array(ManagementBaseObject baseObj, string property)
		{
		...
		public static UInt32[] ToUInt32Array(ManagementBaseObject baseObj, string property)
		{
		...
		public static UInt16[] ToUInt16Array(ManagementBaseObject baseObj, string property)
		{
		...
		public static Int16[] ToInt16Array(ManagementBaseObject baseObj, string property)
		{
		...
		public static byte[] ToByteArray(ManagementBaseObject baseObj, string property)
		{
		...
		public static string[] ToStringArray(ManagementBaseObject baseObj, string property)
		{
		...
		public static Int16 ToInt16(ManagementBaseObject baseObj, string property)
		{
		...
		public static bool ToBool(ManagementBaseObject baseObj, string property)
		{
		...
		public static byte ToByte(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static UInt16 ToUInt16(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static UInt32 ToUInt32(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static UInt64 ToUInt64(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static DateTime? ToDateTime(ManagementBaseObject baseObj, string property)
		{
		...
		public static float ToFloat(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static double ToDouble(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
		...
		public static Int32 ToInt32(ManagementBaseObject baseObj, string property)
		{
			if (!PropertyExists(baseObj, property)) return 0;
			try { if (baseObj[property] == null) return 0; }
			catch { return 0; }
